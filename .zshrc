...
function brewinstall() {
	...
	# restart && reset
	osascript -e 'tell app "Terminal" to do script "brew install check && brew install lcov && brew install gcovr && brew install googletest && brew install cppcheck && killall Terminal"'
	# brew install check
	# brew install lcov
	# brew install gcovr
